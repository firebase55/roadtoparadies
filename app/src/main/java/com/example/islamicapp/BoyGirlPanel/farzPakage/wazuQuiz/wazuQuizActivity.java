...
public class wazuQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wazu2);
        ...
        list = new ArrayList<>();
        r = new Random();
        for (int i = 0; i < new DataProvider().correct.length; i++) {
            list.add(new GetData(new DataProvider().correct[i], new DataProvider().dataprovider[i]));
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b1.getText().toString().equalsIgnoreCase(list.get(turn - 1).getName())) {
                    Toast.makeText(wazuQuizActivity.this, "correct Ans", Toast.LENGTH_SHORT).show();
                    if (turn < 6) {
                        turn++;
                        newQuestion(turn);
                    } else {
                        Toast.makeText(wazuQuizActivity.this, "over", Toast.LENGTH_SHORT).show();


                    }
                } else {
                    new SweetAlertDialog(wazuQuizActivity.this, SweetAlertDialog.ERROR_TYPE)
