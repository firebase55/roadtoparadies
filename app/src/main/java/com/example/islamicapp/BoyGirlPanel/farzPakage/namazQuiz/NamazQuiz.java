package com.example.islamicapp.BoyGirlPanel.farzPakage.namazQuiz;
...
public class NamazQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_namaz_quiz);
        ...
        list = new ArrayList<>();
        r = new Random();
        for (int i = 0; i < new dataBAse().Anss.length; i++) {
            list.add(new getData(new dataBAse().Anss[i], new dataBAse().flags_[i]));
