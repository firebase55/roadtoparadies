package com.example.islamicapp.BoyGirlPanel.girl.namazQuiz;
...
import com.example.islamicapp.BoyGirlPanel.farzPakage.quiz.Datebase;
import com.example.islamicapp.BoyGirlPanel.farzPakage.quiz.country;
...
public class namazQuiz extends AppCompatActivity {
    public Button b1, b2, b3, b4;
    ImageView flg_image;
    List<setterGetter> list;
    Random r;
    int turn = 1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_namaz_quiz2);
        ...
        list = new ArrayList<>();
        r = new Random();
        for (int i = 0; i < new dataSet().Ans.length; i++) {
            list.add(new setterGetter(new dataSet().Ans[i], new dataSet().flags[i]));
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b1.getText().toString().equalsIgnoreCase(list.get(turn - 1).getName())) {
                    Toast.makeText(namazQuiz.this, "correct Ans", Toast.LENGTH_SHORT).show();
                    if (turn < 6) {
                        turn++;
                        newQuestion(turn);
                    } else {
                        Toast.makeText(namazQuiz.this, "over", Toast.LENGTH_SHORT).show();
                ...
                {
                    new SweetAlertDialog(namazQuiz.this,SweetAlertDialog.ERROR_TYPE)
